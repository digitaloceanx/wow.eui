...
EA_TTIP_SPECFLAG_CHECK_RUNES = "Show DK's Runes in the left 1st position of Slef-Buffs";	
...
EA_TTIP_SPECFLAG_CHECK_RAGE = "Show Rage in the left 1st position of Slef-Buffs";						
EA_TTIP_SPECFLAG_CHECK_FOCUS = "Show Focus in the left 1st position of Slef-Buffs";						
EA_TTIP_SPECFLAG_CHECK_ENERGY = "Show Energy in the left 1st position of Slef-Buffs";			
EA_TTIP_SPECFLAG_CHECK_LIGHTFORCE = "Show Chi of Monk in the left 1st position of Self-Buffs";	
EA_TTIP_SPECFLAG_CHECK_SHADOWORBS = "Show Insanity in the left 1st position of Self-Buffs";	
...
EA_SPELL_POWER_MAELSTROM = 11;			-- Maelstrom(Shaman)
EA_SPELL_POWER_LIGHT_FORCE = 12;		-- Chi (Monk)
EA_SPELL_POWER_SHADOW_ORBS = 13;		-- Insanity (Shadow Priest)
...
EA_SPELL_POWER_FURY = 17;				-- Fury (Demonhunter)
...
EA_XOPT_SPECFLAG_LUNARPOWER = "월식";
...
EA_XOPT_SPECFLAG_FOCUS_PET = "Pet Focus";
EA_XOPT_SPECFLAG_LIGHTFORCE = "Chi";
...
EA_XGRPALERT_POWERTYPES = {
	...
	[8]={text="월식", value=EA_SPELL_POWER_LUNARPOWER},
	[9]={text="성스러운 힘", value=EA_SPELL_POWER_HOLY_POWER},
	[10]={text="Chi", value=EA_SPELL_POWER_LIGHT_FORCE},			
	[11]={text="Insanity", value=EA_SPELL_POWER_SHADOW_ORBS},		
...
EA_XSPECINFO_LUNARPOWER = "Lunar Power";
--EA_XSPECINFO_ECLIPSE = "월식(달)";
--EA_XSPECINFO_ECLIPSEORG = "월식(태양)";
EA_XSPECINFO_HOLYPOWER = "성스러운 힘";
EA_XSPECINFO_SHADOWORBS= "Insanity";
EA_XSPECINFO_ENERGY= "Energy";
EA_XSPECINFO_RAGE= "Rage";
EA_XSPECINFO_FOCUS= "Focus";
EA_XSPECINFO_FOCUS_PET= "Pet Focus";
EA_XSPECINFO_LIGHTFORCE= "Chi";
EA_XSPECINFO_ARCANECHARGES= "Arcane Charges";			
EA_XSPECINFO_MAELSTROM= "Maelstrom";	
EA_XSPECINFO_FURY= "Fury";	