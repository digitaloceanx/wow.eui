...
G.unitframe.buffwatch = {
	...
	DRUID = {
		...
		[155777] = ClassBuff(155777, "BOTTOMRIGHT", {0.8, 0.4, 0}),	 -- Wild Growth
		[188550] = ClassBuff(188550, "TOPLEFT", {0.8, 0.4, 0}),	 -- Wild Growth
	},
	PALADIN = {
	...
	MONK = {
		...
		[124682] = ClassBuff(124682, "TOPLEFT", {0.7, 0.4, 0}), -- 氤氲之雾
		[191840] = ClassBuff(191840, "BOTTOMLEFT", {0.7, 0.4, 0}), -- 精华之泉
	},
	ROGUE = {
