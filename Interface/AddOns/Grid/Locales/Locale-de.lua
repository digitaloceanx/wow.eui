...
L["Darken the text color to match the inverted bar."] = "Text abdunkeln, um die invertierte Leiste entsprechen." -- Needs review
...
L["Icon Stack Text"] = "Symbol Stack-Text" -- Needs review
...
L["40 Player Raid Layout"] = "40-Mann-Schlachtzug-Optionen"
...
L["Select which layout to use when in a 40 player raid."] = "Wähle das Layout für einen 40-Mann-Schlachtzug aus"
