...
L["Show the Grid icon on the minimap. Note that some DataBroker display addons may hide the icon regardless of this setting."] = "在小地图显示 Grid 图标。注意，一些 DataBroker 显示插件无论是否设置可能隐藏图标。"
...
L["Adjust the size of the corner indicators."] = "调整角标的尺寸。"
...
L["Adjust the spacing between individual unit frames."] = "调整单个单位框架的间距。"
L["Advanced"] = "高级"
L["Advanced options."] = "高级选项。"
L["Allows mouse click through the Grid Frame."] = "允许透过 Grid 框架点击。"
...
L["Color when %s is below the low threshold value."] = "%s低于阈值下限使用的颜色。"
...
L["Show the time left to tenths of a second, instead of only whole seconds."] = "剩余时间精确到分秒而非显示整数秒。"
L["Show the time remaining, for use with the center icon cooldown."] = "显示的剩余时间，用于中心图标冷却。"
L["Show time left to tenths"] = "剩余时间显示到分秒"
...
L["Color for Not Ready."] = "未就位时的颜色。"
L["Color for Ready."] = "已就位时的颜色。"
L["Color for Waiting."] = "等待时的颜色。"
L["Delay"] = "延迟"
L["Not Ready color"] = "未就位的颜色"
L["R"] = "是"
L["Ready Check"] = "就位确认"
L["Ready color"] = "就位颜色"
...
L["RES"] = "复"
L["Resurrection"] = "复活"
L["Show the status until the resurrection is accepted or expires, instead of only while it is being cast."] = "显示复活直至接受或过期，而非仅在施放中。 "
