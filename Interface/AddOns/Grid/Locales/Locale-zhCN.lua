...
L["Toggle center icon's stack count text."] = "打开/关闭中心图标的堆叠计数文本"
L["Toggle status display."] = "切换此状态是否显示在当前指示器上。\n按住ALT点击可配置此状态的选项"
...
L["Group Anchor"] = "队伍锚点"
L["Hide when in mythic raid instance"] = "在史诗团队副本中隐藏"
L["Hide when in raid instance"] = "在团队副本中隐藏"
...
L["Buff: %s"] = "增益：%s"
L["Buff name"] = "状态名称"
L["Change which information is shown by the status color."] = "更改状态颜色所指示的信息。"
L["Change which information is shown by the status text."] = "更改状态文本所指示的信息。"
--L["Class Filter"] = "职业过滤"
L["Color"] = "颜色"
...
L["Show only dispellable"] = "显示可驱散"
L["Show %s debuffs only if you can dispel them."] = "仅当你可以驱散它们时, 才显示 %s 减益"
