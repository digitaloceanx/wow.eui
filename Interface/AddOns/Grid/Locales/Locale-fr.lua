...
L["Output Frame"] = "Cadre de sortie" -- Needs review
...
L["Options for GridFrame."] = "Options concernant GridFrame." -- Needs review
...
L["Options for GridLayout."] = "Options concernant GridLayout." -- Needs review
...
L["Resets the layout frame's position and anchor."] = "Réinitialise la position et l'ancrage du cadre de style." -- Needs review
L["Right"] = "À droite"
L["Scale"] = "Échelle"
...
-- L["Show all groups"] = ""
L["Show a tab for dragging when Grid is unlocked."] = "Affiche un onglet pour déplacer quand Grid est déverrouillé." -- Needs review
...
L["Reset class colors"] = "Réinitialisez la couleur des classes" -- Needs review
L["Reset class colors to defaults."] = "Réinitialisez la couleur des classes par défaut." -- Needs review
...
L["Color for High Threat."] = "Couleur à utiliser pour la menace élevée." -- Needs review
L["Color for Tanking."] = "Couleur à utiliser pour les tanks."
L["High"] = "Haut"
L["High Threat color"] = "Couleur Menace élevée" -- Needs review
...
L["Color for Waiting."] = "La couleur à utiliser pour ceux qui n'ont pas encore répondu." -- Needs review
L["Delay"] = "Délai"
