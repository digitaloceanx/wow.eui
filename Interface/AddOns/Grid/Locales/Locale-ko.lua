...
L["Thick"] = "두껍게"
L["Thin"] = "얇게"
L["Throttle Updates"] = "업데이트 조절"
L["Throttle updates on group changes. This option may cause delays in updating frames, so you should only enable it if you're experiencing temporary freezes or lockups when people join or leave your group."] = "그룹이 변경될 때 업데이트를 조절합니다. 이 옵션은 창을 업데이트할 때 지연현상을 일으킬 수 있으며, 그룹에 사람이 참여하거나 떠날 때 일시적 멈춤 또는 잠금 현상이 발생할 때만 사용하세요."
...
L["Use the 40 Player Raid layout when in a raid group outside of a raid instance, instead of choosing a layout based on the current Raid Difficulty setting."] = "현재 공격대 난이도 설정에 따른 배치를 선택하는 대신, 공격대 인스턴스가 아닌 야외 공격대 그룹일 경우 40인 배치를 사용합니다."
