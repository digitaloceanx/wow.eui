...
local function StripTextures(object, kill)--by eui.cc
...
local function SkinButton(gmm_button) --by eui.cc
	if gmm_button.SetNormalTexture then gmm_button:SetNormalTexture("") end
	if gmm_button.SetHighlightTexture then gmm_button:SetHighlightTexture("") end
	if gmm_button.SetPushedTexture then gmm_button:SetPushedTexture("") end
	if gmm_button.SetDisabledTexture then gmm_button:SetDisabledTexture("") end
	StripTextures(gmm_button, true)
end
